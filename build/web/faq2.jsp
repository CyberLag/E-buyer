...
<html>
    ...
    <body> 
            ...
            <div class="left-sidebar">
                <div class="breadcrumbs">
                                <ol class="breadcrumb" style="font-size: 17px;">
                                    <li><a href="http://localhost:8084/e-SHOPPER/faq.jsp">FAQ'S</a> </li>
                                </ol>
                            </div>
                <h2>Category</h2>
        ...
        <div class="contact-info" style="font-size: 17px;">
            ...
            <p>A. You can always call 01919-123123 or mail us at founders@eshopper.com.</p>
