...
<html>
    ...
    <head>
        <title>Electronics | e-SHOPPER</title>
    ...
    <body> 
        ...
        <%
            try {
                ...
                String qry1 = "select * from PRODUCT where subcategory_id=12";
                ResultSet rs1 = stmt1.executeQuery(qry1);
                String total_res = new String();
                total_res = "select count(*) from PRODUCT where subcategory_id=12";
                        ...
                        <div class="left-sidebar">
                            <div class="breadcrumbs">
                                <ol class="breadcrumb" style="font-size: 17px;">
                                    <li><a href="http://localhost:8084/e-SHOPPER/electronics.jsp">Electronics</a>
                                </ol>
                            </div>
                            <h2>Category</h2>
                        ...
                        <div class="features_items"><!--features_items-->
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userid") != null) {%>electronics.jsp<%} else {%>login.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="electronics.jsp" method="post">
                            ...
                            <%
                                ...
                                if (found_something
                                    ...
                                    page_number += "0";
                            %>
                            <div style="float: right"><form action="electronics.jsp" method="post">
