...
//  String key=request.getParameter("key");
                String qry1 = "select * from PRODUCT where subcategory_id=13";
                ResultSet rs1 = stmt1.executeQuery(qry1);
                String total_res = new String();
                total_res = "select count(*) from PRODUCT where subcategory_id=13";
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <form style="font-size:17px; text-align:right" name="input" action="http://localhost:8084/e-SHOPPER/search.jsp" me-SHethod="get">
                        ...
                        <div class="left-sidebar">
                            <div class="breadcrumbs">
                                <ol class="breadcrumb" style="font-size: 17px;">
                                    <li><a href="http://localhost:8084/e-SHOPPER/sweets.jsp">Sweets</a>
                                </ol>
                            </div>
                            <h2>Category</h2>
                        ...
                        <div class="features_items"><!--features_items-->
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--CART-->
                                            <form action="sweets.jsp" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userid") != null) {%>sweets.jsp<%} else {%>login.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="sweets.jsp" method="post">
                            ...
                            <%
                                ...
                                if (found_something
                                    ...
                                    page_number += "0";
                            %>
                            <div style="float: right"><form action="sweets.jsp" method="post">
                                    <input name="found_something" type="hidden" value=<%=page_number%>>
                                    <button type="submit" class="btn btn-default add-to-cart">More</button>
                                </form></div>
