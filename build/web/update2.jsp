        ...
        <%
            ...
            try {
                ...
                if (request.getParameter("insert") != null) {
                    ...
                    ResultSet rs6;
                    rs6 = stmt6.executeQuery("select max(product_code)+1 as mx from product");
                    rs6.next();
                    insert_prod = "insert into product values (" + rs6.getInt("mx") + ",'" + request.getParameter("insert") + "'," + request.getParameter("sell_price") + "," + request.getParameter("purchase_price") + ",'" + request.getParameter("exp_date") + "',0," + request.getParameter("stock_rem") + "," + request.getParameter("br_code") + "," + request.getParameter("subcategory") + ",'" + request.getParameter("unit") + "')";
                ...
                if (request.getParameter("delete_from_db") != null) {
                    ...
                    delete_prod = "delete from product where  product_code=" + request.getParameter("delete_from_db");
                    ...
                    update_prod = "update product set product_sell_price=" + request.getParameter("sell_price") + " , product_purchase_price=" + request.getParameter("purchase_price") + " , product_stock_remaining=" + request.getParameter("stock_rem") + " where product_code=" + request.getParameter("update_db");
                    //out.print(update_prod);
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="http://localhost:8084/e-SHOPPER/account.jsp"><i class="fa fa-user"></i><%=session.getAttribute("userid")%></a></li>
            ...
            <div class="container">
                <div class="breadcrumbs">
                    <ol class="breadcrumb" style="font-size: 17px;">
                        ...
                        <a href="http://localhost:8084/e-SHOPPER/update.jsp"> Update Database</a>
                    </ol>
                </div>
                                    ...
                                    <form method="POST" action="update.jsp?is_image_selected=yes" enctype="multipart/form-data" style="width: 110px; padding-top: 5px; height: 65px;">
                                        <%
                                            ...
                                            if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
                                                ...
                                                saveFile = "C:/Users/Al-Amin/Desktop/e-SHOPPER/web/images/" + rs9.getString("mx") + ".jpg";
...
.                                        <input type="file" name="file" value="" /><br>
                        ...
                        <form action="update.jsp" method="post">
                            ...
                            <td class="cart_price" style="width:80px;">
                                    <input class="cart_quantity_input" type="number" name="br_code" min="1" value="1" autocomplete="off" size="4" style="width:50px;">
                            </td>
                ...
                <%
                    ...
                    ResultSet rs7;
                    qry7 = "select max(subcategory_id) as mxc from product";
                    ...
                    for (int iter = 1; iter <= maxcat; iter++) {
                        ...
                        ResultSet rs;
                        qry = "select * from product where subcategory_id=" + iter;
                        rs = stmt.executeQuery(qry);
