...
<html>
    ...
    <head>
        <title>Breakfast | E-Shopper</title>
    ...
    <body> 
        ...
        <%
            try {
                ...
                String qry1 = "select * from PRODUCT where subcategory_id=2";
                ResultSet rs1 = stmt1.executeQuery(qry1);
                String total_res = new String();
                total_res = "select count(*) from PRODUCT where subcategory_id=2";
                        ...
                        <div class="left-sidebar">
                            <div class="breadcrumbs">
                                <ol class="breadcrumb" style="font-size: 17px;">
                                    <li><a>Grocery</a>  <i class=" fa fa-caret-right"></i></li>
                                    <a href="http://localhost:8084/e-SHOPPER/breakfast.jsp"> Breakfast</a>
                                </ol>
                            </div>
                            <h2>Category</h2>
                        ...
                        <div class="features_items"><!--features_items-->
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <!--CART-->
                                            <form action="breakfast.jsp" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userid") != null) {%>breakfast.jsp<%} else {%>login.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="breakfast.jsp" method="post">
                            ...
                            <%
                                ...
                                if (found_something
                                    ...
                                    page_number += "0";
                            %>
                            <div style="float: right"><form action="breakfast.jsp" method="post">
