                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="mensdress.jsp"><button type="button" style="margin-left:50px;" class="btn btn-default get">Get it now</button></a>
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="beverages.jsp"><button type="button" style="margin-left:10px;" class="btn btn-default get">Get it now</button></a>
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="personal.jsp"><button type="button" style="margin-left:20px;" class="btn btn-default get">Get it now</button></a>
