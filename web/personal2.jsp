...
<html>
    ...
    <head>
        <title>Personal & Care | e-SHOPPER</title>
    ...
    <body> 
        ...
        <%
            try {
                ...
                String qry1 = "select * from PRODUCT where subcategory_id=8";
                ResultSet rs1 = stmt1.executeQuery(qry1);
                String total_res = new String();
                total_res = "select count(*) from PRODUCT where subcategory_id=8";
                        ...
                        <div class="left-sidebar">
                            <div class="breadcrumbs">
                                <ol class="breadcrumb" style="font-size: 17px;">
                                    <li><a>Beauty & Health</a>  <i class=" fa fa-caret-right"></i></li>
                                    <a href="http://localhost:8084/e-SHOPPER/personal.jsp"> Personal Care</a>
                                </ol>
                            </div>
                            <h2>Category</h2>
                        ...
                        <div class="features_items"><!--features_items-->
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userid") != null) {%>personal.jsp<%} else {%>login.jsp<%}%>" method="post">
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="personal.jsp" method="post">
                            ...
                            <%
                                ...
                                if (found_something
                                    ...
                                    page_number += "0";
                            %>
                            <div style="float: right"><form action="personal.jsp" method="post">
