                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="http://localhost:8084/e-SHOPPER/mensdress.jsp"><button type="button" style="margin-left:50px;" class="btn btn-default get">Get it now</button></a>
                                        
                                        <h2>50% Sale on T-Shirt </h2> 
                                        
                                        <p> Polo Brand T-Shirt is on 50% Sale </p>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="http://localhost:8084/e-SHOPPER/beverages.jsp"><button type="button" style="margin-left:10px;" class="btn btn-default get">Get it now</button></a>
                                        
                                        <h2>10 Tk off </h2>
                                        <p> Coca-Cola 1 Liter is at 41 Tk only </p>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="item">
                                    <div class="col-sm-6">
                                        <br><br><br>
                                        <a href="http://localhost:8084/e-SHOPPER/personal.jsp"><button type="button" style="margin-left:20px;" class="btn btn-default get">Get it now</button></a>
                                        
                                        <h2>Free Brash </h2>
                                        <p> A Flexible Brash is Free with 250 gm Colgate </p>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="product-image-wrapper">
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <h2><%out.print(price);%> taka<li style="font-size: 15px; font-style: italic; color: green"><%out.print(rs9.getString("unit"));%></li></h2>
                                    ...
                                    <div class="choose">
                                        <ul class="nav nav-pills nav-justified">
                                            <li><form action="<%if (session.getAttribute("userid") != null) {%>index.jsp<%} else {%>login.jsp<%}%>" method="post">
